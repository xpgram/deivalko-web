    ...
    return (
      <div className={styles.wrapper}>
        ...
        <p className={styles.text}>
          ...
          I am an indie games designer
        </p>
        <p className={styles.text}>
          and artist based in Oregon. This site is still under construction, but I'm not getting any business right now anyway, so whatever.
        </p>
        <br/>
        <p className={styles.text}>
